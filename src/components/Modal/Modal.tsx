...
const Modal: React.FC<PropsWithChildren<any>> = ({ children, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 z-10 flex items-center justify-center">
      <div 
        className="bg-white rounded-md relative mx-auto my-auto border border-gray-300 p-4 overflow-y-auto max-h-screen w-4/5 h-4/5 min-w-[900px] min-h-[900px] max-w-[1100px] modal"
      >
